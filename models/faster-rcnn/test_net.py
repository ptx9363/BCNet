...
from faster_rcnn.alexnet import alexnet
...
if __name__ == '__main__':
    ...
    load_name = os.path.join(input_dir,
                             'faster_rcnn2_{}_{}_{}.pth'.format(args.checksession, args.checkepoch, args.checkpoint))
    ...
    if args.net == 'vgg16':
        ...
        fasterRCNN = alexnet(imdb.classes, pretrained=True,
                             class_agnostic=args.class_agnostic)
